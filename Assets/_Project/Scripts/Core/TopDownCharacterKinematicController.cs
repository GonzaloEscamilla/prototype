...
namespace _Project.Scripts.Core
{
    public class TopDownCharacterKinematicController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            movementController.SetInputs(new MoveInputData(_movementInput, _movementInput));
            // movementController.SetInputs(new MoveInputData(_movementInput, _characterFacingDirection));
        }
